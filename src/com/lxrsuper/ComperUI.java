...
public class ComperUI {
	...
	JToolBar bar;
	JTextArea textArea;
	JTextArea textAreaDis1;
	JTextArea textAreaDis2;
	public ComperUI() {
		
		f = new JFrame("JAVA编译器");
		...
		f.add(textArea = new JTextArea()); 
		f.add(textAreaDis1 = new JTextArea()); 
		f.add(textAreaDis2 = new JTextArea()); 
